"""Alembic environment — async engine support since DATABASE_URL uses
asyncpg (Postgres) or aiosqlite (SQLite) drivers.
"""
...
def run_migrations_online() -> None:
    """Entry point for online migrations — bridges into the async engine."""
